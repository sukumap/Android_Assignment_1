...
public class ImageOpsBoundService extends ImageOpsImpl {
    ...
    public void bindService() {
        if (mRequestMessengerRef == null) {
            ...
            // user.  
            // TODO - you fill in here.
            Intent serviceIntent = DownloadImagesBoundService.makeIntent(mActivity.get().getApplicationContext());
            ...
            // TODO -- you fill in here.
            mActivity.get().bindService(serviceIntent,mServiceConnection,Context.BIND_AUTO_CREATE);
