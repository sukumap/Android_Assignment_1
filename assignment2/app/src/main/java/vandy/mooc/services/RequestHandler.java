...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        // TODO -- you fill in here.
            final Messenger replyMesssenger = requestMessage.getMessenger();
        // Get the URL associated with the message data.
        // TODO -- you fill in here.
         final Uri urldata = requestMessage.getImageURL();
        // Get the directory pathname where the image will be stored.
        // TODO -- you fill in here.
        final String pathname = requestMessage.getDirectoryPathname();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d(TAG, " url data is " + urldata + "pathname is " + pathname);
                    Log.d(TAG," request code is " + requestcode);
                    // TODO -- you fill in here.
                    Uri deviceuri = Utils.downloadImage(mService.get().getApplicationContext(), urldata, pathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    sendPath(replyMesssenger,deviceuri,urldata,requestcode);
